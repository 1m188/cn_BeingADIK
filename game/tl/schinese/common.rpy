...
translate schinese strings:
    ...
    new "此菜单中的选项旨在改善无障碍体验。它们未必适用于所有游戏，某些选项组合可能导致游戏无法运行——这并非游戏或引擎的问题。更换字体时，尽量保持文字大小与原来一致，效果最佳。"
    ...
    new "本程序包含依据多种许可证发布的自由软件，其中包括 MIT 许可证与 GNU 宽松通用公共许可证。完整的软件清单（含源代码链接）可在{a=https://www.renpy.org/l/license}此处{/a}查看。"
    ...
    new "剪贴板朗读已开启。按 'Shift+C' 关闭。"

    # renpy/common/00preferences.rpy:601
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "屏幕朗读将读出“[renpy.display.tts.last]”。按 'Alt+Shift+V' 关闭。"
    ...
    new "\n{color=#cfc}✔ 已预加载的图像（正常）{/color}\n{color=#fcc}✘ 未预加载的图像（异常）{/color}\n{color=#fff}拖动以移动。{/color}"
    ...
    new "它的显卡驱动可能已过时或工作不正常。这会导致图形显示缓慢或错误。"

    # renpy/common/00gltest.rpy:259
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "{a=edit:1:log.txt}log.txt{/a} 文件中可能包含帮助你判断计算机故障的信息。"

    # renpy/common/00gltest.rpy:264
    old "More details on how to fix this can be found in the {a=[url]}documentation{/a}."
    new "更多修复方法详见{a=[url]}文档{/a}。"
    ...
    new "将 traceback.txt 以 BBCode 格式复制到剪贴板，供 https://lemmasoft.renai.us/ 等论坛使用。"
    ...
    new "将 traceback.txt 以 Markdown 格式复制到剪贴板，供 Discord 使用。"
    ...
    new "尝试回滚到先前的时间点，让你可以存档或做出不同的选择。"
